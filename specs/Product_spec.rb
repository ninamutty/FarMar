...
describe 'testing sales instance method' do
    let (:product_instance) {FarMar::Product.find(12)}
...
describe 'testing number_of_sales instance method' do
    let (:product_instance) {FarMar::Product.find(45)}
...
describe 'testing self.by_vendor(vendor_id) class method' do
